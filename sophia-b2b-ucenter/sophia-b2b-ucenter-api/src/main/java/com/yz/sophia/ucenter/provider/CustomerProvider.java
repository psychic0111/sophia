package com.yz.sophia.ucenter.provider;
 ...
 * 		比如sophia-b2b-ucenter-provider 为sophia-b2b-ucenter项目provider模块提供的服务
 * path 为api的相对路径,格式:${server.servlet.context-path|/相对路径
 * 		比如/api/customer
 */
@Api("客户管理服务")
@FeignClient(name = "sophia-b2b-ucenter-provider",path = "/api/customer")
