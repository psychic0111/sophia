package com.yz.sophia.ucenter.eureka;
 ...
 */
@EnableFeignClients(basePackages = {"com.yz.sophia.ucenter.provider"})//"com.yz.sophia.ucenter.provider","com.yz.sophia.ucenter.provider"
public class EurekaApplication {
    ...
    public static void main(String[] args) {
        val context = SpringApplication.run(com.yz.sophia.ucenter.Application.class, args);
        /**
         * 获取注入对象方式二
         */
