package com.yz.sophia.ai.eureka;

import com.yz.sophia.ai.model.request.CustomerAddReq;
import com.yz.sophia.ai.provider.CustomerProvider;
import lombok.val;
 ...
 */
@EnableFeignClients(basePackages = {"com.yz.sophia.ai.provider"})//"com.yz.sophia.ucenter.provider","com.yz.sophia.ai.provider"
public class EurekaApplication {
    ...
    public static void main(String[] args) {
        val context = SpringApplication.run(com.yz.sophia.ai.Application.class, args);
        /**
         * 获取注入对象方式二
         */
