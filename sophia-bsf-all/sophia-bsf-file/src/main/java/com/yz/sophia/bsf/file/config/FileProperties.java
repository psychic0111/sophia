package com.yz.sophia.bsf.file.config;
...
public class FileProperties {
    ...
    public HotFileProperties getDefaultHotFile() {
        ...
        properties.setUploadUrl(ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","hotfile_url",""));
        properties.setLoginToken(ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","hotfile_logintoken",""));
        return properties;
    }

    public QiniuProperties getDefaultQiniu() {
        QiniuProperties properties = new QiniuProperties();
        properties.setAccessKey(ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","accesskey",""));
        properties.setSecurityKey(ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","securitykey",""));
