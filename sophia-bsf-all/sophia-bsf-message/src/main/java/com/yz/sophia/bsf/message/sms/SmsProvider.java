package com.yz.sophia.bsf.message.sms;
...
import com.yz.sophia.bsf.message.base.MessageException;
...
public class SmsProvider {
    ...
    public SmsProvider(SmsProperties smsProperties) {
        apiUrl = StringUtils.isEmpty(smsProperties.getSmsUrl())? ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smsurl",""):smsProperties.getSmsUrl();
        apiUrlBak= StringUtils.isEmpty(smsProperties.getSmsUrlBak())?ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smsurlbak",""):smsProperties.getSmsUrlBak();
        authorization = "Basic " + Base64.getEncoder().encodeToString(((StringUtils.isEmpty(smsProperties.getSmsUser())?ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smsuser",""):smsProperties.getSmsUser()) + ":" + (StringUtils.isEmpty(smsProperties.getSmsPassword())?ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smspassword",""):smsProperties.getSmsPassword())).getBytes());
        basicBody = new HashMap<>();
        basicBody.put("SMS_SERVER", StringUtils.isEmpty(smsProperties.getSmsServer())? ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smsserver",""):smsProperties.getSmsServer());
        basicBody.put("USER_ID", StringUtils.isEmpty(smsProperties.getSmsUser())? ReflectionUtils.tryGetStaticFieldValue("com.yz.sophia.bsf.core.base.BsfBaseConfig","smsuser",""):smsProperties.getSmsUser());
    }
    /**
     * 新增接口
     * 发送短信
    ...
    public  void sendText(String phone, String content)  {
        sendRequest("/sms/v1/yzsms/industrial", phone, content);
    }
    ...
    public  void sendVoiceCode(String phone, String code)  {
        ...
        sendRequest("/sms/v1/yzsms/voice", phone, code);
    }
