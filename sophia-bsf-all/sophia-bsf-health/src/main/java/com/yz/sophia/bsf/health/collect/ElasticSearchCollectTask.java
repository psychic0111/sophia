...
public class ElasticSearchCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        ...
        if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.yz.sophia.bsf.elasticsearch.impl.ElasticSearchProvider"), false) != null) {
            var hook = (Collector.Hook)ReflectionUtils.callMethod(ReflectionUtils.tryClassForName("com.yz.sophia.bsf.elasticsearch.impl.ElasticSearchMonitor"), "hook", null);
            if (hook != null) {
