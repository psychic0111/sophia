...
import com.yz.sophia.bsf.health.base.HealthException;
import lombok.Data;
import lombok.val;
...
public class JedisCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        val item = ContextUtils.getBean(ReflectionUtils.classForName("com.yz.sophia.bsf.redis.impl.RedisClusterMonitor"), false);
        if (item != null) {
            try {
