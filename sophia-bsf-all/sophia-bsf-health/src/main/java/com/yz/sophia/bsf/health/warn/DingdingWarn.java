package com.yz.sophia.bsf.health.warn;

import com.yz.sophia.bsf.core.util.*;
import com.yz.sophia.bsf.health.base.AbstractWarn;
import com.yz.sophia.bsf.health.base.Message;
import com.yz.sophia.bsf.health.config.WarnProperties;
import com.yz.sophia.bsf.message.dingding.DingdingProvider;
import lombok.val;
...
public class DingdingWarn extends AbstractWarn {
    ...
    public DingdingWarn(){
        driverExsit  = ReflectionUtils.tryClassForName("com.yz.sophia.bsf.message.dingding.DingdingProvider")!=null;
    }
