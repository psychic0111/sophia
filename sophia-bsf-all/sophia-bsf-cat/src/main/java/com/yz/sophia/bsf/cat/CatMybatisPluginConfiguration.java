        ...
        private String getSqlURL() {
            ...
            if (dataSource != null) {
                ...
                for (String cls:classs){
                    ...
                    Class<?> dataSourceClass = com.yz.sophia.bsf.core.util.ReflectionUtils.tryClassForName(clsName);
                    if(dataSourceClass!=null && dataSourceClass.isAssignableFrom(dataSource.getClass()))
                    {return com.yz.sophia.bsf.core.util.ReflectionUtils.tryCallMethod(dataSource,clsMethod,null,"");}
                }
