...
import com.yz.sophia.bsf.shardingjdbc.base.DataSource;
import com.yz.sophia.bsf.shardingjdbc.base.SlaveOnly;
...
public class ShardingJdbcDynamicDataSourceAspect {
    @Pointcut("@within(com.yz.sophia.bsf.shardingjdbc.base.MasterOnly) " +
            "|| @annotation(com.yz.sophia.bsf.shardingjdbc.base.MasterOnly)")
    ...
    @Pointcut("@within(com.yz.sophia.bsf.shardingjdbc.base.SlaveOnly) " +
            "|| @annotation(com.yz.sophia.bsf.shardingjdbc.base.SlaveOnly)")
    ...
    @Pointcut("@within(com.yz.sophia.bsf.shardingjdbc.base.DataSource) " +
            "|| @annotation(com.yz.sophia.bsf.shardingjdbc.base.DataSource)")
