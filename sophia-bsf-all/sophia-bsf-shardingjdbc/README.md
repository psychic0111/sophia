...
```java 
<dependency>
	<artifactId>sophia-bsf-shardingjdbc</artifactId>
...
spring.shardingsphere.sharding.default-database-strategy.hint.algorithm-class-name=DataSourceShardingAlgorithm
```
