package com.yz.sophia.bsf.redis.config;
...
import com.yz.sophia.bsf.redis.RedisException;
import com.yz.sophia.bsf.redis.RedisProvider;
import com.yz.sophia.bsf.redis.annotation.RedisCacheAspect;
import com.yz.sophia.bsf.redis.impl.ClusterRedisProvider;
import com.yz.sophia.bsf.redis.impl.RedisClusterMonitor;
    ...
    public RedisProvider redisProvider(JedisCluster jedisCluster, RedisProperties properties) {
        ...
        if (keyPrefix == null || keyPrefix.length() == 0) {
            ...
            if (springAppName != null && springAppName.length() > 0) {
                keyPrefix = springAppName.replace("sophia-", "").replace("-provider", "");
            }
        }
