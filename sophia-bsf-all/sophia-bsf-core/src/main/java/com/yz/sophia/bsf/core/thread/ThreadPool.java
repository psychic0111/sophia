package com.yz.sophia.bsf.core.thread;

import com.yz.sophia.bsf.core.base.BsfException;
import com.yz.sophia.bsf.core.base.Ref;
...
public class ThreadPool {
     ...
     * @param <T>
     */
    public <T> void parallelFor(String taskName,int parallelCount, List<T> array, final com.yz.sophia.bsf.core.base.Callable.Action1<T> action) {
        checkHealth();
     ...
     * @param <T>
     */
    public <T> void parallelFor2(String taskName,int parallelCount, List<T> array, final com.yz.sophia.bsf.core.base.Callable.Action1<T> action){
        checkHealth();
        threadMonitor.hook().run(taskName, ()-> {
            var parallelCount2 = parallelCount;
            if(parallelCount2>array.size()){
