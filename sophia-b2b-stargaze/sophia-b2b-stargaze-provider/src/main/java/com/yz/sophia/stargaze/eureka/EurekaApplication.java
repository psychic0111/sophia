package com.yz.sophia.stargaze.eureka;
 ...
 */
@EnableFeignClients(basePackages = {"com.yz.sophia.stargaze.provider"})//"com.yz.sophia.ucenter.provider","com.yz.sophia.stargaze.provider"
public class EurekaApplication {
    ...
    public static void main(String[] args) {
        val context = SpringApplication.run(com.yz.sophia.stargaze.Application.class, args);
        /**
         * 获取注入对象方式二
         */
